...
export function ProvedorUsuário({ children }) {
  ...
  return (
    <ContextoUsuário.Provider value={{
        ...
        confirmaçãoUsuário, setConfirmaçãoUsuário,
        mostrarModalConfirmação, setMostrarModalConfirmação,
        cpfVerificado, setCpfVerificado,
        novaSenha, setNovaSenha,
        tokenRecuperacao, setTokenRecuperacao
