...
import { TAMANHOS, TEMA_PADRÃO, estilizarBotão, estilizarCard, estilizarDialog,
  ...
  estilizarPasswordInput, estilizarPasswordTextInputBorder, estilizarSubtítulo, opçõesCores, estilizarBotãoRemover }
...
export default function CadastrarUsuário() {
  ...
  const opçõesPerfis = [{ label: "Jornalista", value: "jornalista" },
